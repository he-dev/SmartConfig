...
namespace SmartConfig.Tests.Reflection.ReflectorTests
{
    ...
    public class GetSettingInfos
    {
        ...
        {
            ((ConfigurationInfo)null).GetSettingInfos();
        }

        [TestMethod]
        public void GetsRelevantSettingInfos()
        {
            var configurationInfo = new ConfigurationInfo(typeof(Foo));
            var settingInfos = configurationInfo.GetSettingInfos().ToList();
    ...
    public class GetSettingKeyNames
    {
        ...
        public void GetsMainKeyName()
        {
            CollectionAssert.AreEqual(
                new[] { "Name" },
                Reflector.GetSettingKeyNames<Setting>().ToList()
            );
        }
        ...
        public void GetsCustomKeyNames()
        {
            CollectionAssert.AreEqual(
                ...
                Reflector.GetSettingKeyNames<TestSetting>().ToList()
            );
        }
    }
}